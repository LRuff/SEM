...
We consider the evaluation of $V_c = \I_{oc}^{-1}$ for the case that the complete-data density $f(\bm Y \, | \, \theta)$ is from an exponential family, since this is most common in practical applications. This means that the complete-data density has the following representation
